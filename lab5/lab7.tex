...
\subsection*{Выводы}
В процессе выполнения данной лабораторной работы я познакомился с итераторами и реализовал класс итератора по N-дереву. Мне кажется часто итераторы очень удобны для перемещения по контейнеру.
